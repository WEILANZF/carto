...
#ifndef PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto
#define PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto 
...
class ConstantVelocityPoseExtrapolatorOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.ConstantVelocityPoseExtrapolatorOptions) */ {
 public:
  ...
  inline ConstantVelocityPoseExtrapolatorOptions* New() const final {
    return CreateMaybeMessage<ConstantVelocityPoseExtrapolatorOptions>(NULL);
  }

  ConstantVelocityPoseExtrapolatorOptions* New(::google::protobuf::Arena* arena) const final {
...
class ImuBasedPoseExtrapolatorOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.ImuBasedPoseExtrapolatorOptions) */ {
 public:
  ...
  inline ImuBasedPoseExtrapolatorOptions* New() const final {
    return CreateMaybeMessage<ImuBasedPoseExtrapolatorOptions>(NULL);
  }

  ImuBasedPoseExtrapolatorOptions* New(::google::protobuf::Arena* arena) const final {
...
class PoseExtrapolatorOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseExtrapolatorOptions) */ {
 public:
  ...
  inline PoseExtrapolatorOptions* New() const final {
    return CreateMaybeMessage<PoseExtrapolatorOptions>(NULL);
  }

  PoseExtrapolatorOptions* New(::google::protobuf::Arena* arena) const final {
...
inline ::cartographer::mapping::proto::ConstantVelocityPoseExtrapolatorOptions* PoseExtrapolatorOptions::mutable_constant_velocity() {
  ...
  if (constant_velocity_ == NULL) {
    auto* p = CreateMaybeMessage<::cartographer::mapping::proto::ConstantVelocityPoseExtrapolatorOptions>(GetArenaNoVirtual());
...
inline ::cartographer::mapping::proto::ImuBasedPoseExtrapolatorOptions* PoseExtrapolatorOptions::mutable_imu_based() {
  ...
  if (imu_based_ == NULL) {
    auto* p = CreateMaybeMessage<::cartographer::mapping::proto::ImuBasedPoseExtrapolatorOptions>(GetArenaNoVirtual());
    imu_based_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto
