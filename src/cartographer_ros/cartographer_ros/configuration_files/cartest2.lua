...
options = {
  ...
  map_frame = "map",
  tracking_frame = "laser", --laser base_link imu_link
  published_frame = "odom", --base_link use odom--
  odom_frame = "odom",
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 120--35 90 120  160 200--
...
--TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.hit_probability=0.75
