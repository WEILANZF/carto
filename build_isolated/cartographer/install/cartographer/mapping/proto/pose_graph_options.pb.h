...
class PoseGraphOptions_OverlappingSubmapsTrimmerOptions2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseGraphOptions.OverlappingSubmapsTrimmerOptions2D) */ {
 public:
  ...
  inline PoseGraphOptions_OverlappingSubmapsTrimmerOptions2D* New() const final {
    return CreateMaybeMessage<PoseGraphOptions_OverlappingSubmapsTrimmerOptions2D>(NULL);
  }

  PoseGraphOptions_OverlappingSubmapsTrimmerOptions2D* New(::google::protobuf::Arena* arena) const final {
