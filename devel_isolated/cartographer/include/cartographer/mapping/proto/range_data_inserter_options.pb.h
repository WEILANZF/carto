...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_cartographer_2fmapping_2fproto_2frange_5fdata_5finserter_5foptions_2eproto 
...
class RangeDataInserterOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.RangeDataInserterOptions) */ {
 public:
  ...
  inline RangeDataInserterOptions* New() const final {
    return CreateMaybeMessage<RangeDataInserterOptions>(NULL);
  }
